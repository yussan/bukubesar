...
app.controller('ctrlHome', ['$scope','$timeout',function($scope,$timeout){
	...
	$scope.homePresentation = function(param)
	{
		switch(param){
			case 'personil':
			$scope.downArrowPersonil = true;
			$scope.downArrowPenjualan = false;
			$scope.downArrowPersediaan = false;
			$scope.downArrowAkuntansi = false;
			...
			break;
			case 'penjualan':
			$scope.downArrowPersonil = false;
			$scope.downArrowPenjualan = true;
			$scope.downArrowPersediaan = false;
			$scope.downArrowAkuntansi = false;
			...
			$scope.downArrowPersonil = false;
			$scope.downArrowPenjualan = false;
			$scope.downArrowPersediaan = true;
			$scope.downArrowAkuntansi = false;

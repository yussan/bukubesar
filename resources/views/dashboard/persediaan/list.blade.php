        ...
        <div class="row">
            <div ng-style="styleItemList" class="parent-list">
                    <div class="">
                        ...
                        <div class="col-sm-11">
                        <!-- edit tags -->
                        <form class="col-xs-12" ng-hide="editTags" role="form">
                        <div style="padding-left:0" class="col-xs-10">
                        ...
                        <div class="col-xs-2">
                            <button ng-click="updateTags()" type="button" class="btn btn-default box-persediaan-btn"><span class="glyphicon glyphicon-floppy-disk"></span></button></div>
                        </form>
                        </div>
                    </div>
                    <br/>
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li ng-repeat="tag in tags" role="presentation"><a ng-click="itemsByTag(tag)" href="#tag-{{tag}}" aria-controls="profile" role="tab" data-toggle="tab">{{tag}}</a></li>
                </ul>
                <br/>
                <div ng-hide="alertKosong" class="alert alert-warning">persediaan kosong</div>
